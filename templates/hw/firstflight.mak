...
<div>
    ...
    <a target="_blank" href="https://github.com/decause/bizlegfoss">https://github.com/decause/bizlegfoss</a>.</p>
    ...
    <div class="alert alert-success">
        ...
        <ul>
            ...
            <li>Fork <a href="https://github.com/decause/bizlegfoss">the
        ...
        this).</li>
            ...
            student in bizlegfoss fall of 2014 would have their YAML file in the
            ...
            *exactly* (meaning it is case and whitespace sensitive.)
            ...
            href="http://bizlegfoss-ritigm.rhcloud.com/participants">Participants</a>
            page.)</li>
        </ul>
    </div>
</div>
